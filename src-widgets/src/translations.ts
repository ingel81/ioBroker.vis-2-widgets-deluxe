const translations = {
    en: {
        ...
        active_color_tooltip:
            'Icon color in active state. Mode-dependent: Switch/Dimmer = on, Heating = active, value over threshold, or for Navigation: currently on the target view.',
        inactive_color: 'Inactive Color',
        inactive_color_tooltip:
            'Icon color in default/inactive state. For Navigation this means: not currently on the target view.',
        ...
        deluxe_switch_toggle_settings: 'Deluxe - Switch (Toggle Optics)',
        deluxe_switch_toggle_label_settings: 'Deluxe - Switch (Toggle Label)',
        ...
        switch_display_style: 'Display style',
        switch_display_style_tooltip:
            'Choose between an icon-based switch or a Material toggle switch (slider with knob).',
        switch_display_style_icon: 'Icon (default)',
        switch_display_style_toggle: 'Toggle switch',
        switch_toggle_size: 'Toggle size',
        switch_toggle_size_small: 'Small',
        switch_toggle_size_medium: 'Medium',
        switch_toggle_track_on_color: 'Track color (ON)',
        switch_toggle_track_off_color: 'Track color (OFF)',
        switch_toggle_knob_on_color: 'Knob color (ON)',
        switch_toggle_knob_off_color: 'Knob color (OFF)',
        switch_toggle_label_on: 'Label when ON',
        switch_toggle_label_on_tooltip: 'Optional text shown next to the toggle when ON',
        switch_toggle_label_off: 'Label when OFF',
        switch_toggle_label_off_tooltip: 'Optional text shown next to the toggle when OFF',
        switch_toggle_label_position: 'Label position',
        switch_toggle_label_on_color: 'Label color (ON)',
        switch_toggle_label_off_color: 'Label color (OFF)',
        switch_toggle_label_font_size: 'Label font size',
        ...
        // Navigation Mode
        one_icon_mode_navigation: 'Navigation',
        deluxe_navigation_settings: 'Deluxe - Navigation',
        navigation_target_view: 'Target view',
        navigation_target_view_tooltip: 'vis-2 view to navigate to on click',
        navigation_label: 'Label',
        navigation_label_tooltip: 'Optional text shown next to the icon (leave empty for icon only)',
        navigation_label_position: 'Label position',
        navigation_label_font_size: 'Label font size',
        navigation_label_color: 'Inactive label color',
        navigation_label_active_color: 'Active label color',
        navigation_label_text_align: 'Label alignment',
    },
    de: {
        set_label: 'Deluxe Widgets',
        ...
        show_card: 'Als Kachel anzeigen',
        without_card: 'Ohne Kachel',
        ...
        deluxe_card_settings: 'Deluxe - Kachel-Einstellungen',
        ...
        active_color_tooltip:
            'Icon-Farbe im aktiven Zustand. Modusabhängig: z.B. Schalter/Dimmer an, Heizung aktiv, Wert über Schwelle, oder bei Navigation: aktuell auf Ziel-View.',
        inactive_color: 'Inaktive Farbe',
        inactive_color_tooltip:
            'Icon-Farbe im inaktiven/Standard-Zustand. Bei Navigation: aktuell nicht auf Ziel-View.',
        dialog_settings: 'Dialog-Einstellungen',
        slider_color: 'Schieberegler-Farbe',
        buttons_color: 'Schaltflächen-Farbe',
        card_background_color: 'Kachel-Hintergrundfarbe',
        ...
        deluxe_switch_toggle_settings: 'Deluxe - Schalter (Toggle-Optik)',
        deluxe_switch_toggle_label_settings: 'Deluxe - Schalter (Toggle-Beschriftung)',
        ...
        switch_display_style: 'Darstellung',
        switch_display_style_tooltip:
            'Auswahl zwischen Icon-Schalter oder Material-Toggle-Switch (Schieberegler mit Knopf).',
        switch_display_style_icon: 'Icon (Standard)',
        switch_display_style_toggle: 'Toggle-Switch',
        switch_toggle_size: 'Toggle-Größe',
        switch_toggle_size_small: 'Klein',
        switch_toggle_size_medium: 'Mittel',
        switch_toggle_track_on_color: 'Track-Farbe (EIN)',
        switch_toggle_track_off_color: 'Track-Farbe (AUS)',
        switch_toggle_knob_on_color: 'Knopf-Farbe (EIN)',
        switch_toggle_knob_off_color: 'Knopf-Farbe (AUS)',
        switch_toggle_label_on: 'Beschriftung wenn EIN',
        switch_toggle_label_on_tooltip: 'Optionaler Text neben dem Toggle wenn EIN',
        switch_toggle_label_off: 'Beschriftung wenn AUS',
        switch_toggle_label_off_tooltip: 'Optionaler Text neben dem Toggle wenn AUS',
        switch_toggle_label_position: 'Beschriftungs-Position',
        switch_toggle_label_on_color: 'Beschriftungs-Farbe (EIN)',
        switch_toggle_label_off_color: 'Beschriftungs-Farbe (AUS)',
        switch_toggle_label_font_size: 'Schriftgröße',
        // Heating KNX Specific
        ...
        one_icon_mode_navigation: 'Navigation',
        deluxe_navigation_settings: 'Deluxe - Navigation',
        navigation_target_view: 'Ziel-View',
        navigation_target_view_tooltip: 'vis-2 View, zu der bei Klick navigiert wird',
        navigation_label: 'Beschriftung',
        navigation_label_tooltip: 'Optionaler Text neben dem Icon (leer = nur Icon)',
        navigation_label_position: 'Position der Beschriftung',
        navigation_label_font_size: 'Schriftgröße der Beschriftung',
        navigation_label_color: 'Inaktive Schriftfarbe',
        navigation_label_active_color: 'Aktive Schriftfarbe',
        navigation_label_text_align: 'Beschriftungs-Ausrichtung',
    },
    ru: {
